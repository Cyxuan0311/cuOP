...
int main(int argc, char** argv){
    ...
    std::cout << "MaxPool2D input shape: (" << batch_size << ", " << channels << ", " << height << ", " << width << ")" << std::endl;
    std::cout << "MaxPool2D params: pool=(" << pool_h << ", " << pool_w << "), stride=(" << stride_h << ", " << stride_w << ")" << std::endl;
    ...
    maxpool.Forward(input, output, 2, 3);
    ...
    std::cout << "Average MaxPool2D time: " << ms / 100 << " ms" << std::endl;
